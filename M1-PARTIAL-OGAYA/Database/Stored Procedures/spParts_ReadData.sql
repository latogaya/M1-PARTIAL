...
BEGIN
    ...
    FROM [dbo].[CASES]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'CASE' = @SearchString OR 'CASEs' = @SearchString OR 'TOWER' = @SearchString OR 'TOWERS' = @SearchString)
    ...
    FROM [dbo].[FANS]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'FAN' = @SearchString OR 'FANs' = @SearchString OR 'CASE FAN' = @SearchString OR 'CASE FANs' = @SearchString)
    ...
    FROM [dbo].[CPU]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'CPU' = @SearchString OR 'CPUs' = @SearchString OR 'PROCESSOR' = @SearchString OR 'PROCESSORs' = @SearchString)
    ...
    FROM [dbo].[GPU]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'GPU' = @SearchString OR 'GPUs' = @SearchString OR 'GRAPHICS CARD' = @SearchString OR 'GRAPHICS CARDs' = @SearchString)
    ...
    FROM [dbo].[RAM]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'RAM' = @SearchString OR 'RAMs' = @SearchString  OR 'MEMORY' = @SearchString OR 'MEMORIES' = @SearchString)
    ...
    FROM [dbo].[SSD]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'SSD' = @SearchString OR 'SSDs' = @SearchString OR 'STORAGE' = @SearchString OR 'STORAGES' = @SearchString)
    ...
    FROM [dbo].[PSU]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'PSU' = @SearchString OR 'PSUs' = @SearchString OR 'POWER SUPPLY' = @SearchString OR 'POWER SUPPLIES' = @SearchString)
    ...
    FROM [dbo].[MOBO]
    WHERE (@SearchString IS NULL OR [Name] LIKE '%' + @SearchString + '%' OR [Code] LIKE '%' + @SearchString + '%' OR [Brand] 
    LIKE '%' + @SearchString + '%' OR 'MOBO' = @SearchString OR 'MOBOS' = @SearchString OR 'MOTHERBOARD' = @SearchString OR 'MOTHERBOARDS' = @SearchString)
