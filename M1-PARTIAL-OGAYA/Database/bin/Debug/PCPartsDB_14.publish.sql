...
GO
PRINT N'The following operation was generated from a refactoring log file 6900630a-69c8-498c-9d44-4264eafb0f19';

PRINT N'Rename [dbo].[PC].[Price] to UnitPrice';


GO
EXECUTE sp_rename @objname = N'[dbo].[PC].[Price]', @newname = N'UnitPrice', @objtype = N'COLUMN';
