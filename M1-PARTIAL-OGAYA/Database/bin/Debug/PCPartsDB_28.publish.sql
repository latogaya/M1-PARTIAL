...
GO
ALTER PROCEDURE [dbo].[spParts_InsertData]
(
...
BEGIN
    ...
    SET @sql = N'INSERT INTO ' + QUOTENAME(@tableName) + ' (Name, Code, Brand, UnitPrice) VALUES (@name, @code, @brand, @unitPrice)';
    EXEC sp_executesql @sql, N'@name VARCHAR(50), @code VARCHAR(50), @brand VARCHAR(50), @unitPrice DECIMAL(18,2)', @name, @code, @brand, @unitPrice;
END
GO
