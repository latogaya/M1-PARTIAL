...
BEGIN
    ...
    DECLARE @PartTable TABLE ([PCPart] NVARCHAR(MAX), [Name] NVARCHAR(MAX), [UnitPrice] DECIMAL(10, 2));
    ...
    BEGIN
        INSERT INTO @PartTable ([PCPart], [Name], [UnitPrice])
        SELECT 'CASES', [Name], [UnitPrice] FROM [dbo].[CASES] WHERE [Id] = @CaseId;
